/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f64f21271f9a263b1eb6097ab0742026)
// Runtime types generated with workerd@1.20250906.0 2025-10-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CF_TOKEN: string;
		CF_ACCOUNT_ID: string;
		CF_GATEWAY_ID: string;
		RunningRoutineAgent: DurableObjectNamespace<import("./src/index").RunningRoutineAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_TOKEN" | "CF_ACCOUNT_ID" | "CF_GATEWAY_ID">> {}
}
